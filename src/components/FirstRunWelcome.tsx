  ...
  return (
    <AnimatePresence>
      {onboarded ? null : (
        ...
        >
          <h2 id="welcome-heading" className="text-base font-semibold text-ink">
          ...
          <button
            ...
            className="mt-3 rounded-full bg-healthy px-4 py-2 text-sm font-semibold text-canvas outline-none transition-colors hover:bg-healthy/90 focus-visible:ring-2 focus-visible:ring-healthy/50"
          >
            Got it
          </button>
        </motion.section>
